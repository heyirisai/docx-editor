 ...
 * live in `@heyirisai/docx-editor-core/layout-bridge` and are shared with the
...
export { applyCellSelectionHighlight } from '@heyirisai/docx-editor-core/layout-bridge';
