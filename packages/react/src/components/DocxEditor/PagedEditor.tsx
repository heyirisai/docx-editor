...
// Layout bridge
import { DEFAULT_PAGE_HEIGHT_PX } from '@heyirisai/docx-editor-core/layout-bridge';
...
export interface PagedEditorProps {
  ...
  extensionManager?: import('@heyirisai/docx-editor-core/prosemirror/extensions').ExtensionManager;
