...
import type { FontDefinition, ScrollToParaIdOptions } from '@heyirisai/docx-editor-core/utils';
...
import { collectHeadings } from '@heyirisai/docx-editor-core/utils';
import {
...
interface EditorState {
  ...
  paragraphTabs: import('@heyirisai/docx-editor-core/types/document').TabStop[] | null;
...
// `@heyirisai/docx-editor-core/docx` so React + Vue share the same
