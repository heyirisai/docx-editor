...
import type { NumberFormat } from '@heyirisai/docx-editor-core/types/document';
...
export type { ListType, ListState } from '@heyirisai/docx-editor-core/utils/listState';
import type { ListState } from '@heyirisai/docx-editor-core/utils/listState';
