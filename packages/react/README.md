...
<p align="center">
  <a href="https://www.npmjs.com/package/@heyirisai/docx-editor-react"><img src="https://img.shields.io/npm/v/@heyirisai/docx-editor-react.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@heyirisai/docx-editor-react"><img src="https://img.shields.io/npm/dm/@heyirisai/docx-editor-react.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
```tsx
import { DocxEditor, createEmptyDocument } from '@heyirisai/docx-editor-react';
import '@heyirisai/docx-editor-react/styles.css';
...
- `@heyirisai/docx-editor-react` — `DocxEditor`, `renderAsync`, public types
- `@heyirisai/docx-editor-react/ui` — toolbar primitives, pickers, sidebars, dialogs
- `@heyirisai/docx-editor-react/hooks` — `useAutoSave`, `useTableSelection`, ...
- `@heyirisai/docx-editor-react/dialogs` — dialog components barrel
- `@heyirisai/docx-editor-react/plugin-api` — plugin host and plugin-facing types
- `@heyirisai/docx-editor-react/styles` — style constants (`EDITOR_CSS_PATH`, z-index)
...
`@heyirisai/docx-editor-core` is installed transitively. Add it to your `package.json` only if your own code imports core APIs directly. Strict installers like pnpm with peer auto-install disabled may also need the ProseMirror peers listed in `package.json`.
