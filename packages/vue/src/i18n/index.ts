 ...
 * and locale data live in `@heyirisai/docx-editor-i18n`; this module wraps
...
import { createT, deepMerge, en } from '@heyirisai/docx-editor-i18n';
import type { LocaleStrings, TFunction, Translations } from '@heyirisai/docx-editor-i18n';
