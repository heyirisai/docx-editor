...
import { getTableContext } from '@heyirisai/docx-editor-core/prosemirror/extensions/nodes/TableExtension';
import type { ImageLayoutTarget } from '@heyirisai/docx-editor-core/prosemirror/commands';
