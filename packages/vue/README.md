...
<p align="center">
  <a href="https://www.npmjs.com/package/@heyirisai/docx-editor-vue"><img src="https://img.shields.io/npm/v/@heyirisai/docx-editor-vue.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@heyirisai/docx-editor-vue"><img src="https://img.shields.io/npm/dm/@heyirisai/docx-editor-vue.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
> **Using Nuxt?** [`@heyirisai/nuxt-docx-editor`](https://www.npmjs.com/package/@heyirisai/nuxt-docx-editor) wraps this adapter as a Nuxt 3 & 4 module — SSR-safe component registration and the stylesheet are wired automatically.
...
<script setup lang="ts">
import { ref } from 'vue';
import { DocxEditor, createEmptyDocument } from '@heyirisai/docx-editor-vue';
import '@heyirisai/docx-editor-vue/styles.css';
...
`createDocumentWithText(text, options?)` is the same idea with a starting paragraph already typed. Both helpers are re-exported from `@heyirisai/docx-editor-core` so you don't need a separate dependency.
...
| [`@heyirisai/nuxt-docx-editor`](https://www.npmjs.com/package/@heyirisai/nuxt-docx-editor)     | <img src="https://cdn.simpleicons.org/nuxt/00DC82" width="20" align="middle" /> &nbsp; Nuxt 3 & 4 module wrapping this adapter.            |
...
```ts
import { renderAsync } from '@heyirisai/docx-editor-vue';
...
- `@heyirisai/docx-editor-vue` — `DocxEditor`, `renderAsync`, public types
- `@heyirisai/docx-editor-vue/ui` — toolbar primitives, pickers, sidebars, dialogs
- `@heyirisai/docx-editor-vue/composables` — `useDocxEditor`, `useZoom`, `useTableSelection`, ...
- `@heyirisai/docx-editor-vue/dialogs` — dialog SFCs barrel
- `@heyirisai/docx-editor-vue/plugin-api` — plugin host and plugin-facing types
- `@heyirisai/docx-editor-vue/styles` — style constants (`EDITOR_CSS_PATH`, z-index)
