/**
 * @heyirisai/docx-editor-agents/ai-sdk/server
 *
 ...
 * `getToolSchemas` from `@heyirisai/docx-editor-agents/server` and shape it
 ...
 * `@heyirisai/docx-editor-agents/ai-sdk/react` or
