import type { Document, DocumentBody } from '@heyirisai/docx-editor-core/headless';
import { parseDocx } from '@heyirisai/docx-editor-core/headless';
import type {
  ContentBlock,
  GetContentOptions,
  ReviewChange,
...
export class DocxReviewer {
  ...
  async toBuffer(): Promise<ArrayBuffer> {
    ...
    const { repackDocx } = await import('@heyirisai/docx-editor-core/headless');
