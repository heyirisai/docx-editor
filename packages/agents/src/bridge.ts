/**
 * @heyirisai/docx-editor-agents/bridge
 *
 * Editor bridge that connects agent tools to a live `DocxEditor` instance.
 * Framework-agnostic. The React adapter lives in
 * `@heyirisai/docx-editor-agents/react`.
 *
 * @example
 * ```ts
 * import { createEditorBridge } from '@heyirisai/docx-editor-agents/bridge';
...
} from '@heyirisai/docx-editor-core/utils/paragraphFlashTypes';
...
function getDocumentBody(
...
): import('@heyirisai/docx-editor-core/headless').DocumentBody | null {
  ...
  if (pagedRef) {
    const doc = pagedRef.getDocument() as
      | import('@heyirisai/docx-editor-core/headless').Document
      | null;
