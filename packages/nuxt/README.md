...
<p align="center">
  <a href="https://www.npmjs.com/package/@heyirisai/nuxt-docx-editor"><img src="https://img.shields.io/npm/v/@heyirisai/nuxt-docx-editor.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@heyirisai/nuxt-docx-editor"><img src="https://img.shields.io/npm/dm/@heyirisai/nuxt-docx-editor.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
# @heyirisai/nuxt-docx-editor

Nuxt 3 & 4 module for the [docx-editor](https://docx-editor.dev). Wraps [`@heyirisai/docx-editor-vue`](https://www.npmjs.com/package/@heyirisai/docx-editor-vue) and auto-imports an SSR-safe `<DocxEditor>` component — no manual import, no `<ClientOnly>` boilerplate.
...
export default defineNuxtConfig({
  ...
  docxEditor: {
    ...
    injectStyles: true, // push @heyirisai/docx-editor-vue/styles.css into nuxt.options.css
  },
});
```
...
| `injectStyles` | `boolean` | `true`  | Set `false` to import `@heyirisai/docx-editor-vue/styles.css` yourself. |
...
| [`@heyirisai/nuxt-docx-editor`](https://www.npmjs.com/package/@heyirisai/nuxt-docx-editor)     | <img src="https://cdn.simpleicons.org/nuxt/00DC82" width="20" align="middle" /> &nbsp; Nuxt 3 & 4 module wrapping the Vue adapter.         |
...
Other `@heyirisai/docx-editor-vue` surfaces — `renderAsync`, `createEmptyDocument`, the `DocxEditorProps`/`DocxEditorRef` types, and the `/ui`, `/dialogs`, `/plugin-api` subpaths — are not re-exported by this module. Import them from the adapter directly, and add it to your own `dependencies` so the import is explicit:
...
```ts
import { renderAsync, createEmptyDocument } from '@heyirisai/docx-editor-vue';
```
