/**
 * @heyirisai/docx-editor-core/headless
 *
 ...
 * @example
 * ```ts
 * import { DocumentAgent, parseDocx, pluginRegistry } from '@heyirisai/docx-editor-core/headless';
 * import { docxtemplaterPlugin } from '@heyirisai/docx-editor-core/core-plugins';
 *
 * // Register plugins
