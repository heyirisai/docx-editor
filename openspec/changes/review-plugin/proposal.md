...
Separate package (`@heyirisai/docx-editor-agents`) under BSL-1.1 — source-available, free for non-production, paid subscription for commercial use.

## What Changes

- **New package** `packages/agent-use/` → `@heyirisai/docx-editor-agents` (BSL-1.1)
...
- **Peer dependency**: `@heyirisai/docx-editor-core` — no code duplication
