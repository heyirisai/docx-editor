...
- Ship locale JSON files under `i18n/en.json` (required, bundled) with community-contributed locales as optional imports (e.g., `@heyirisai/docx-editor-react/i18n/pl.json`)
