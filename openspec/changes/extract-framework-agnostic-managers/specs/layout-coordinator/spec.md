...
The `LayoutCoordinator` class SHALL import only from `@heyirisai/docx-editor-core` internals and vanilla DOM APIs. It SHALL NOT import React, Vue, or any framework.
