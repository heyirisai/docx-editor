...
- `@heyirisai/docx-editor-vue@0.0.1`
- `@heyirisai/docx-editor-core@0.0.28`
- `@heyirisai/docx-editor-agents@0.5.1`
- `@heyirisai/docx-editor-i18n@0.0.1`
...
pack-only check cannot fetch `@heyirisai/docx-editor-core` from the public
...
`@heyirisai/docx-editor-vue/styles.css`, mounted the component with
