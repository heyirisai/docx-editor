...
import { TextSelection } from '@heyirisai/docx-editor-core/prosemirror';
import {
  acceptChangeById,
  rejectChangeById,
  acceptAllChanges,
...
import { loadFont } from '@heyirisai/docx-editor-core/utils';
...
export function App() {
  ...
  // `loadFont(name)` from `@heyirisai/docx-editor-core/utils` directly.
