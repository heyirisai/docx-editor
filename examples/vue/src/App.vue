...
import { DocxEditor, type DocxEditorRef } from '@heyirisai/docx-editor-vue';
import { de as deLocale } from '@heyirisai/docx-editor-i18n';
import ExampleSwitcher from '../../shared/ExampleSwitcher.vue';
import BrandLogo from '../../shared/BrandLogo.vue';
import { createEmptyDocument, findStartPosForParaId } from '@heyirisai/docx-editor-core';
import type { Document } from '@heyirisai/docx-editor-core/types/document';
import { setSuggestionMode } from '@heyirisai/docx-editor-core/prosemirror/plugins';
import {
  acceptChangeById,
  rejectChangeById,
  acceptAllChanges,
...
import {
  ...
  AgentComposer,
  type AgentMessage,
} from '@heyirisai/docx-editor-agents/vue';
import { getToolDisplayName } from '@heyirisai/docx-editor-agents/vue';
