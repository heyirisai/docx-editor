...
export const PACKAGES = [
  {
    name: '@heyirisai/docx-editor-core',
    root: 'packages/core',
    pkgSlug: 'docx-editor-core',
  },
  {
    name: '@heyirisai/docx-editor-i18n',
    root: 'packages/i18n',
    pkgSlug: 'docx-editor-i18n',
  },
  {
    name: '@heyirisai/docx-editor-react',
    root: 'packages/react',
    pkgSlug: 'docx-editor-react',
    // Strips dev-time `paths` so Extractor follows `@heyirisai/...` via
  ...
  {
    name: '@heyirisai/docx-editor-agents',
