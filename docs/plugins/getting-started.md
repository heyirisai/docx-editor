...
| Entry point  | `@heyirisai/docx-editor-react/plugin-api`                  | `@heyirisai/docx-editor-core/core-plugins`             |
...
import { PluginHost } from '@heyirisai/docx-editor-react/plugin-api';
...
```ts
import type { EditorPlugin } from '@heyirisai/docx-editor-react/plugin-api';
