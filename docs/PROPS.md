...
```ts
import { DocxEditor, type DocxEditorRef, renderAsync } from '@heyirisai/docx-editor-react';
import '@heyirisai/docx-editor-react/styles.css';
```

```ts
import { DocxEditor, type DocxEditorRef, renderAsync } from '@heyirisai/docx-editor-vue';
...
import type { Comment } from '@heyirisai/docx-editor-core';
