## API Report File for "@heyirisai/docx-editor-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@heyirisai/docx-editor-core/types/agentApi';
import { AIAction } from '@heyirisai/docx-editor-core/types/agentApi';
import { ColorValue } from '@heyirisai/docx-editor-core/types/document';
import { createDefaultFindOptions } from '@heyirisai/docx-editor-core/utils/findReplace';
import { createDefaultListState } from '@heyirisai/docx-editor-core/utils/listState';
import { createSearchPattern } from '@heyirisai/docx-editor-core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@heyirisai/docx-editor-core/types/document';
import { escapeRegexString } from '@heyirisai/docx-editor-core/utils/findReplace';
import { findAllMatches } from '@heyirisai/docx-editor-core/utils/findReplace';
import { findInDocument } from '@heyirisai/docx-editor-core/utils/findReplace';
import { findInParagraph } from '@heyirisai/docx-editor-core/utils/findReplace';
import { FindMatch } from '@heyirisai/docx-editor-core/utils/findReplace';
import { FindOptions } from '@heyirisai/docx-editor-core/utils/findReplace';
import { FindResult } from '@heyirisai/docx-editor-core/utils/findReplace';
import { FontOption } from '@heyirisai/docx-editor-core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@heyirisai/docx-editor-core';
import { getDefaultHighlightOptions } from '@heyirisai/docx-editor-core/utils/findReplace';
import { getDefaultPrintOptions } from '@heyirisai/docx-editor-core';
import { getMatchCountText } from '@heyirisai/docx-editor-core/utils/findReplace';
import { HighlightOptions } from '@heyirisai/docx-editor-core/utils/findReplace';
import { isEmptySearch } from '@heyirisai/docx-editor-core/utils/findReplace';
import { isPrintSupported } from '@heyirisai/docx-editor-core';
import { ListState } from '@heyirisai/docx-editor-core/utils/listState';
import { openPrintWindow } from '@heyirisai/docx-editor-core';
import { ParagraphAlignment } from '@heyirisai/docx-editor-core/types/document';
import { ParsedClipboardContent } from '@heyirisai/docx-editor-core/utils';
import { parsePageRange } from '@heyirisai/docx-editor-core';
import { PrintOptions } from '@heyirisai/docx-editor-core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@heyirisai/docx-editor-core/utils/findReplace';
import { replaceFirstInContent } from '@heyirisai/docx-editor-core/utils/findReplace';
import { scrollToMatch } from '@heyirisai/docx-editor-core/utils/findReplace';
import { SectionProperties } from '@heyirisai/docx-editor-core/types/document';
import { SelectionContext } from '@heyirisai/docx-editor-core/types/agentApi';
import { Style } from '@heyirisai/docx-editor-core/types/document';
import { StyleType } from '@heyirisai/docx-editor-core/types/document';
import { Table } from '@heyirisai/docx-editor-core/types/document';
import { TableCell } from '@heyirisai/docx-editor-core/types/document';
import { TabStop } from '@heyirisai/docx-editor-core/types/document';
import { Theme } from '@heyirisai/docx-editor-core/types/document';
import { TranslationKey } from '@heyirisai/docx-editor-i18n';
import { triggerPrint } from '@heyirisai/docx-editor-core';
